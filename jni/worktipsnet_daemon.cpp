#include "network_worktips_worktipsnet_WorktipsnetDaemon.h"
...
extern "C"
{
  ...
  Java_network_worktips_worktipsnet_WorktipsnetDaemon_Obtain(JNIEnv *env, jclass)
  {
  ...
  Java_network_worktips_worktipsnet_WorktipsnetDaemon_Free(JNIEnv *env, jclass, jobject buf)
  {
  ...
  Java_network_worktips_worktipsnet_WorktipsnetDaemon_Configure(JNIEnv *env, jobject self,
                                                    jobject conf)
  {
  ...
  Java_network_worktips_worktipsnet_WorktipsnetDaemon_Mainloop(JNIEnv *env, jobject self)
  {
  ...
  JNIEXPORT jboolean JNICALL
  Java_network_worktips_worktipsnet_WorktipsnetDaemon_IsRunning(JNIEnv *env, jobject self)
  {
    llarp_main *ptr = GetImpl< llarp_main >(env, self);
  ...
  JNIEXPORT jboolean JNICALL
  Java_network_worktips_worktipsnet_WorktipsnetDaemon_Stop(JNIEnv *env, jobject self)
  {
    llarp_main *ptr = GetImpl< llarp_main >(env, self);
    if(ptr == nullptr)
      return JNI_FALSE;
  ...
  JNIEXPORT jboolean JNICALL
  Java_network_worktips_worktipsnet_WorktipsnetDaemon_InjectVPN(JNIEnv *env, jobject self,
                                                    jobject vpn)
  {
    llarp_main *ptr         = GetImpl< llarp_main >(env, self);
    worktipsnet_jni_vpnio *impl = GetImpl< worktipsnet_jni_vpnio >(env, vpn);
