...
#define MyAppName "Worktipsnet"
#define MyAppVersion "0.6.1"
#define MyAppPublisher "Worktips Project"
#define MyAppURL "https://worktipsnet.org"
#define MyAppExeName "worktipsnetui.exe"
...
OutputBaseFilename=worktipsnet-win32
Compression=lzma2/ultra64
SolidCompression=yes
VersionInfoVersion=0.6.1
VersionInfoCompany=Worktips Project
VersionInfoDescription=Worktipsnet for Microsoft® Windows® NT™
#ifndef RELEASE
...
#endif
VersionInfoProductName=Worktipsnet
VersionInfoProductVersion=0.6.1
InternalCompressLevel=ultra64
MinVersion=0,5.0
ArchitecturesInstallIn64BitMode=x64
VersionInfoCopyright=Copyright ©2018-2020 Worktips Project
...
#ifdef SINGLE_ARCH
Source: "{#DevPath}build\worktipsnet.exe"; DestDir: "{app}"; Flags: ignoreversion
; don't ship it, we don't have a public api yet!
;Source: "{#DevPath}build\libworktipsnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "dbghelp64.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}build\worktipsnet.exe"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
;Source: "{#DevPath}build\libworktipsnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
Source: "dbghelp32.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsWin64
Source: "{#DevPath}build64\worktipsnet.exe"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
;Source: "{#DevPath}build64\libworktipsnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
Source: "dbghelp64.dll"; DestDir: "{app}"; DestName: "dbghelp.dll"; Flags: ignoreversion; Check: IsWin64
#endif
; UI has landed!
#ifndef RELEASE
Source: "{#DevPath}ui-win32\bin\debug\worktipsnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\worktipsnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\worktipsnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}ui-win32\bin\release\worktipsnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\worktipsnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\worktipsnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#endif
; eh, might as well ship the 32-bit port of everything else
Source: "{#DevPath}build\testAll.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}build\worktipsnetctl.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion
Source: "worktipsnet-bootstrap.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Type: filesandordirs; Name: "{userappdata}\.worktipsnet"
...
Filename: "{app}\worktipsnet-bootstrap.exe"; Parameters:"-L https://seed.worktipsnet.org/worktipsnet.signed --cacert rootcerts.pem -o ""{userappdata}\.worktipsnet\bootstrap.signed"""; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated; Description: "bootstrap dht"; StatusMsg: "Downloading initial RC..."
