...
namespace llarp
{
  ...
  struct KeyManager
  {
   ...
   private:
    ...
    bool m_usingWorktipsd          = false;
    std::string m_worktipsdRPCAddr = "127.0.0.1:22023";
    std::string m_worktipsdRPCUser;
    std::string m_worktipsdRPCPassword;
    ...
    /// Requests the identity key from worktipsd via HTTP (curl)
    bool
    loadIdentityFromWorktipsd();
  };
