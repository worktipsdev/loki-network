...
extern "C"
{
  ...
  /// packet writer to send packets to worktipsnet internals
  struct llarp_vpn_writer_pipe;
  /// packet reader to recv packets from worktipsnet internals
  ...
  struct llarp_vpn_io
  {
    ...
    /// user data
    void *user;
    /// hook set by user called by worktipsnet core when worktipsnet is done with the
    /// vpn io
    void (*closed)(struct llarp_vpn_io *);
    /// hook set by user called from worktipsnet core after attempting to inject
  ...
  /// info about the network interface that we give to worktipsnet core
  ...
  /// get the packet pipe for writing IP packets to worktipsnet internals
  ...
  /// get the packet pipe for reading IP packets from worktipsnet internals
  /// returns nullptr if llarp_vpn_io is nullptr or not initialized
  struct llarp_vpn_pkt_reader *
  llarp_vpn_io_packet_reader(struct llarp_vpn_io *io);

  /// blocking read on packet reader from worktipsnet internals
  ...
  /// blocking write on packet writer to worktipsnet internals
